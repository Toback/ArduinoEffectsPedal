// Granular Synthesis for Arduino Uno
// by Asher Toback
// Jan 2017
// 
...
grain size: a way to have variable buffer length. grain of 500 means
            ...
            result to the DAC. 
pitch shift: we must index through out arrays to out the 8-bit 
...
i : Should be thought of as time.
*/
...
//We divide by newScale so must add at least 1, but add 2 for some
//reason.
void checkScale(){
